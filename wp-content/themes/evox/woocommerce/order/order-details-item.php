        ...
        global $wpdb;
			...
			if(get_post_type($evox_tour_id) == 'tour'){
                ...
                if($order_tour_data->name_combo != ''){
                    echo apply_filters( 'woocommerce_order_item_quantity_html', ' <strong class="product-quantity">('. esc_html__('Combo: ','evox') . esc_html($order_tour_data->name_combo) . ')</strong>');
                }else{
                    echo apply_filters( 'woocommerce_order_item_quantity_html', ' <strong class="product-quantity">( '. esc_html__('Adult x','evox') . esc_html($order_tour_data->total_adults) . esc_html__(' and ','evox') . esc_html__('Child x','evox') . esc_html($order_tour_data->total_kids) . ' )</strong>');
                }
            }else{
