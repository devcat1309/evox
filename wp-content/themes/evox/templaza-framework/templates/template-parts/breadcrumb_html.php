...
$templaza_blog_title         = esc_html__('Blog','evox');
$templaza_home_title         = esc_html__('Home','evox');
...
if ( !is_front_page() ) {
    ...
    /* Home page */
    //echo '<li class="item-home-txt"><span>'.esc_html__('You are here: ','evox').'</span></li>';
    ...
    elseif ( is_single() ) {
        ...
        /* Year link */
        echo '<li class="item-year item-year-' . esc_attr(get_the_time('Y')) . '"><a href="' . esc_url(get_year_link( get_the_time('Y') )) . '" title="' . esc_attr(get_the_time('Y')) . '">' . esc_html(get_the_time('Y')) . esc_html__(' Archives','evox') . '</a></li>';

        /* Month link */
        echo '<li class="item-month item-month-' . esc_attr(get_the_time('m')) . '"><a href="' . esc_url(get_month_link( get_the_time('Y'), get_the_time('m') )) . '" title="' . esc_attr(get_the_time('M')) . '">' . esc_html(get_the_time('M')) . esc_html__(' Archives','evox') . '</a></li>';

        /* Day display */
        echo '<li class="item-current item-' . esc_attr(get_the_time('j')) . '"><span class="bread-current bread-' . esc_attr(get_the_time('j')) . '"> ' . esc_html(get_the_time('jS')) . ' ' . esc_html(get_the_time('M')) . esc_html__(' Archives','evox') . '</span></li>';
        ...
        /* Month display */
        echo '<li class="item-month item-month-' . esc_attr(get_the_time('m')) . '"><span class="bread-month bread-month-' . esc_attr(get_the_time('m')) . '" title="' . esc_attr(get_the_time('M')) . '">' . esc_html(get_the_time('M')) . esc_html__(' Archives','evox') . '</span></li>';

    } elseif ( is_year() ) {

        /* Display year archive */
        echo '<li class="item-current item-current-' . esc_attr(get_the_time('Y')) . '"><span class="bread-current bread-current-' . esc_attr(get_the_time('Y')) . '" title="' . esc_attr(get_the_time('Y')) . '">' . esc_html(get_the_time('Y')) . esc_html__(' Archives','evox') . '</span></li>';
        ...
        /* Display author name */
        echo '<li class="item-current item-current-' . esc_attr($templaza_userdata->user_nicename) . '"><span class="bread-current bread-current-' . esc_atrr($templaza_userdata->user_nicename) . '" title="' . esc_attr($templaza_userdata->display_name) . '">' . esc_html__('Author: ','evox') . esc_html($templaza_userdata->display_name) . '</span></li>';

    } elseif ( get_query_var('paged') ) {

        /* Paginated archives */
        echo '<li class="item-current item-current-' . esc_attr(get_query_var('paged')) . '"><span class="bread-current bread-current-' . esc_attr(get_query_var('paged')) . '" title="Page ' . esc_attr(get_query_var('paged')) . '">'.esc_html__('Page','evox') . ' ' . esc_html(get_query_var('paged')) . '</span></li>';

    } elseif ( is_search() ) {

        /* Search results page */
        echo '<li class="item-current item-current-' . esc_attr(get_search_query()) . '"><span class="bread-current bread-current-' . esc_attr(get_search_query()) . '" title="' . esc_attr__('Search results for: ','evox') . esc_attr(get_search_query()) . '">' . esc_html__('Search results for: ','evox') . esc_html(get_search_query()) . '</span></li>';
