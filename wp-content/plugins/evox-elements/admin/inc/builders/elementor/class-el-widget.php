 ...
 */
defined( 'Evox_Elements_ELEMENTOR' ) || exit;

if ( ! class_exists( 'Evox_Elements_El_Widget' ) ) {
    /**
     * Class Evox_Elements_El_Widget
     */
    abstract class Evox_Elements_El_Widget extends Widget_Base {
        ...
        public function __construct( array $data = [], array $args = null ) {
            ...
            /**
             * @var $config_class Evox_Elements_Abstract_Config
             */
...
//            $controls = \Evox_Elements_Builder_El_Mapping::mapping( $this->options() );
            $current_section    = '';
        ...
        protected function render() {
            ...
            do_action( 'evox-elements/before-element-template', $this->get_name() );
...
//            \Evox_Elements_Elementor_Helper::get_widget_template( $base_file,
