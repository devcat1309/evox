<?php
/**
 * Evox_Elements Elementor Mapping class
 *
 * @version     1.0.0
 * @author      Evox_Elements
...
if ( ! class_exists( 'Evox_Elements_Builder_El_Mapping' ) ) {
	/**
	 * Class Evox_Elements_El_Mapping
	 */
	class Evox_Elements_Builder_El_Mapping {
...
new Evox_Elements_Builder_El_Mapping();