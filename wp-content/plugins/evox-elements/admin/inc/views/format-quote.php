<div id="vp-pfui-format-quote-fields" style="display: none;" class="vp-pfui-format-wrap">
	...
	<div class="vp-pfui-elm-block">
		<label for="vp-pfui-format-quote-source-content"><?php _e('Quote Content', 'evox-elements'); ?></label>
	...
	<div class="vp-pfui-elm-block">
		<label for="vp-pfui-format-quote-source-author"><?php _e('Quote Author', 'evox-elements'); ?></label>
    ...
    <div class="vp-pfui-elm-block">
        <label for="vp-pfui-format-quote-source-url"><?php _e('Quote Author URL', 'evox-elements'); ?></label>
